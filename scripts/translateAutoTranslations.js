...
const translationMap = {
  ...
  // 头饰相关
  "白色爱心贝雷帽": "White Heart Beret",
  "冰蓝墨镜": "Ice Blue Sunglasses",
  "波点美式头巾": "Polka Dot American Headscarf",
  "格子报童帽": "Checkered Newsboy Cap",
  "公主皇冠": "Princess Crown",
  "浅棕毛绒帽": "Light Brown Fuzzy Hat",
  "紫色毛线帽": "Purple Wool Hat",
  "墨镜黑色头巾": "Sunglasses Black Headscarf",
  "浅粉贝雷帽": "Light Pink Beret",
  "双色针织帽": "Two-Tone Knit Hat",
  "兔子运动帽": "Rabbit Sports Cap",
  "希腊花环": "Greek Wreath",
  "夏威夷": "Hawaiian",
